...
class MontecarloSimulation:
    ...
    def __init__(self, config_manager: ConfigurationManager) -> None:
        ...
        self.busted_ages = []
        self.busted_cnt = 0
        self.ror_gen_list = [ArrayRandGen(config_manager, a[0], a[1]) for a in ROR_STATS]  # List of generators
        return None
    ...
    def mk_ror_df(self, gen_list: list[ArrayRandGen]) -> pd.DataFrame:
        """
    ...
    def run_one_iter(self) -> (pd.DataFrame, bool, int):
        ...
        ror_df = self.mk_ror_df(self.ror_gen_list)
