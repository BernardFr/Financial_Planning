...
class MontecarloSimulation:
    ...
    def load_initial_data(self) -> None:
        ...
        logger.info(display_series(cashflow_total_ser, 2))
        ...
        self.set_initial_holdings(self.asset_class_df)
        ...
        if self.cross_correlated_rvs_flag: # Create the cross-correlated RoR series
            ...
            ror_gen_list = [ArrayRandGen(self.config_manager, mean, stdv, self.seed) for mean, stdv in asset_classes_list]
