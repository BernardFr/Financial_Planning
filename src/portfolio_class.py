#!/usr/bin/env python3
"""
Portfolio Class - for managing the portfolio
Loads the holdings data
Assigns cash to an ETF
Maps the ETF holdings to the broad asset classes for which we have Morningstar stats
Computes the total portfolio market value
Computes the asset allocation percentages

Returns:
    - holdings_df: DataFrame of holdings with market values
    - cash_amount: float of cash amount which is added to the ETF_for_cash ETF
    - asset_class_df: DataFrame of asset classes with their market values 

Asset classes map to broad asset classes for which we have Morningstar stats - or [FUTURE] stats from other sources
"""
